...
public class Shooter extends SubsystemBase {
    ...
    private final TalonFX leftMotor, middleMotor;
    private final List<TalonFX> motors;
    private final VelocityVoltage velocityRequest = new VelocityVoltage(0).withSlot(0);
    private final VoltageOut voltageRequest = new VoltageOut(0);

    //Dobbs you poor soul when you look at this; this is the number that actually changes the RPM
    //Fellas, sit down when I tell you this. Changing this off 0 broke everything.
    private double dashboardTargetRPM = 1000;
    ...
    public Shooter() {
        ...
        motors = List.of(leftMotor, middleMotor);
